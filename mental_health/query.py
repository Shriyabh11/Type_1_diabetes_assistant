...
diabetes_sentences = [
    ...
    # Culturally Specific Examples (High Clarity)
    ...
    # Academic-Specific Examples (High Clarity)
    ...
    # Independence Examples (High Clarity)
    ...
    # Anxious - Distinctive worry language
    ...
    # Angry - Strong negative emotions
    ...
    # Positive - Clear Positive language
...
df = pd.DataFrame(diabetes_sentences, columns=["text", "sentiment"])

# Save to CSV
df.to_csv("diabetes_mood_dataset.csv", index=False)
